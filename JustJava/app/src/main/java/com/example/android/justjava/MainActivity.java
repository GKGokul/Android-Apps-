...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        ...
        intent.setData(Uri.parse("mailto:gkgokul10@gmail.com")); // only email apps should handle this
            intent.putExtra(Intent.EXTRA_SUBJECT, "Just Java order for " + name);
            intent.putExtra(Intent.EXTRA_TEXT,createOrderSummary(price, haswhippedCream, haschocolate));
